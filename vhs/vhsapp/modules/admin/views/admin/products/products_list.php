                            ...
                            <div class="row">
                                <div class="col-sm-12">
                                    <table id="example1" class="table table-bordered table-striped dataTable" role="grid" aria-describedby="example1_info">
                                        <thead>
                                            <tr role="row">
                                                <th class="" tabindex="0" aria-controls="example1" rowspan="1" colspan="1" aria-sort="ascending" aria-label="Rendering engine: activate to sort column descending" style="width: 10px;"><input id="selectAllBoxes" type="checkbox"></th>
                                        ...
                                        <tbody>
                                            ...
                                            <tr role="row" class="odd">
                                                <td><input class="checkBoxes" type="checkbox" name="checkBoxArray[]" value="<?php echo $product->id; ?>"></td>
                                                <td class="sorting_1">
                                                    <?php echo $product->id; ?>
                                                </td>
                                                ...
                                                <td>
                                                    <?php
                                                    if(isset($this->Product_model->get_sub_category_by_id($product->subcategory_id)[0]->subcategory_name)){
                                                        echo $this->Product_model->get_sub_category_by_id($product->subcategory_id)[0]->subcategory_name;
                                                    }else{
                                                        echo 'Not Assigned';
                                                    }
                                                    ?>
