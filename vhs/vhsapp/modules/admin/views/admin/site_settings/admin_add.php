			...
			<div class="col-md-10 col-md-offset-1">
				...
				<div class="box box-primary">
					<div class="box-header with-border">
						...
						<a href="<?php echo base_url();?>admin/site_settings/admin_users/" class="btn btn-danger btn-xs pull-right">Back to Admin List</a>

					</div>
					<!-- /.box-header -->
					<!-- form start -->
					<?php echo form_open_multipart('admin/site_settings/add_admin/');?>
					<div class="box-body">
