				...
				<div class="box">
					<div class="box-header">
						...
						<div class="alert alert-danger">
							<?php echo $this->session->flashdata('admin_deleted'); ?>
						</div>
						<?php endif; ?>
						<?php if($this->session->flashdata('admin_deleted_erro')) : ?>
						<div class="alert alert-danger">
							<?php echo $this->session->flashdata('admin_deleted_erro'); ?>
						</div>
						<?php endif; ?>
						<?php if($this->session->flashdata('admin_updated')) : ?>
						<div class="alert alert-success">
							<?php echo $this->session->flashdata('admin_updated'); ?>
						</div>
						<?php endif; ?>
									...
									<table id="example1" class="table table-bordered table-striped dataTable" role="grid" aria-describedby="example1_info">
										...
										<tbody>
											...
											<tr role="row" class="odd">
												<td class="sorting_1">
													#
													<a href="<?php echo base_url(); ?>admin/site_settings/edit_admin/<?php echo $admin->admin_username; ?>"><?php echo $admin->admin_username; ?></a>
												</td>
												<td>
													<?php echo $this->User_model->get_admin($admin->admin_username)->first_name.' '.$this->User_model->get_admin($admin->admin_username)->last_name; ?>
												</td>
												<td>
													<?php echo $this->User_model->get_admin($admin->admin_username)->admin_email; ?>
												</td>
												<td>
												...
												<td>
													<p data-placement="top" data-toggle="tooltip" title="Edit">
														<a class="btn btn-primary btn-xs" href="<?php echo base_url(); ?>admin/site_settings/edit_admin/<?php echo $admin->admin_username; ?>"><span class="glyphicon glyphicon-pencil"></span></a>
													</p>
												</td>
												<td>
													<p data-placement="top" data-toggle="tooltip" title="Delete">
														<a class="tn btn-danger btn-xs" href="<?php echo base_url(); ?>admin/site_settings/delete_admin/<?php echo $admin->admin_username; ?>"><span class="glyphicon glyphicon-trash"></span></a>
													</p>
												</td>
											</tr>
											<?php endforeach;?>
